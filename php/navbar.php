<nav>
    <div class="nav-wrapper">
        <a href="/" class="brand-logo center">OnlineLibrary</a>
        ...
        <ul class="right hide-on-med-and-down">
            ...
            <li><a href="library.php?page=1" style="vertical-align: middle;"><span class="material-icons" style="vertical-align: text-bottom; margin-right: 1px;">search</span> Browse</a></li>
